...
export default function Sidebar() {
  ...
  }, [screenSize === undefined]) // Only run once when screenSize is first determined
  ...
  if (!openSideMenu) {
    return <>{confirmationModal && <ConfirmationModal modalData={confirmationModal} />}</>
  }

  return (
    <>
      <div className="flex h-[calc(100vh-3.5rem)] min-w-[220px] flex-col border-r-[1px] border-r-richblack-700 bg-richblack-800 py-6">
